...
## [5.1.1](https://github.com/Space48/cloud-seed/compare/v5.1.0...v5.1.2)

### Changed

- Updated the following packages
  - `@cdktf/provider-archive` `^10.3.0` → `^11.0.1`
  - `@cdktf/provider-google` `^14.11.0` → `^16.12.1`
  - `cdktf` `^0.20.10` → `^0.21.0`
  - `cdktf-cli` `^0.20.10` → `^0.21.0`

- Added the following packages
  - `@cdktf/provider-google-beta` `^16.12.1`

### Fixed

- Added `direct_vpc_network_interface` support for VPC connector
...
- Added a default minInstances of 2 which is required when creating a vpcAccessConnector`

## [5.0.1](https://github.com/Space48/cloud-seed/compare/v5.0.0...v5.0.1)

### Fixed

- Added a default maxInstances of 10 which is required when creating a vpcAccessConnector`

## [5.0.0](https://github.com/Space48/cloud-seed/compare/HEAD...v5.0.0)
